...
ALTER TABLE assignmentbuilding ADD CONSTRAINT fk_assignmentbuilding_user FOREIGN KEY (staffid) REFERENCES role(id);
ALTER TABLE assignmentbuilding ADD CONSTRAINT fk_assignmentbuilding_building FOREIGN KEY (buildingid) REFERENCES user(id);
