...
public class BuildingService implements IBuildingService {
	...
	// @Inject //chỉ sử dụng được cho interface,nếu class có constructor không dùng
	// được denpedency
	...
	/*
	 * public BuildingService() { if(buildingRepository==null) { buildingRepository=
	 * new BuildingRepository(); } if(buildingConverter == null) {
